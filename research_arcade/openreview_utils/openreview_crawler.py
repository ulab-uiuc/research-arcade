                ...
                for submission in tqdm(submissions):
                    ...
                    if is_paper:
                        ...
                        if not os.path.exists(paper_pdf):
                            with open(log_file, "a") as log:
                                log.write(f"Paper {paper_id} Failed\n")
                        else:
                            try:
                                ...
                                if is_pdf_delete:
                                    os.remove(paper_pdf)
                                    print(f"Deleted PDF file: {paper_pdf}")
                            except Exception:
                                with open(log_file, "a") as log:
                                    log.write(f"PDF {paper_pdf} Failed\n")
                    if is_revision:
                        # get revisions and their time
                        revisions = {}
                        # get revisions and their time
                                    ...
                                    if idx < 1:
                                        ...
                                        try:
                                            ...
                                            if is_pdf_delete:
                                                ...
                                                print(f"Deleted PDF file: {original_pdf}")
                                        except Exception:
                                            with open(log_file, "a") as log:
                                                log.write(f"PDF {original_pdf} Failed\n")
                                        if idx == num_revision - 1:
                                            try:
                                                ...
                                                if is_pdf_delete:
                                                    ...
                                                    print(f"Deleted PDF file: {modified_pdf}")
                                            except Exception:
                                                with open(log_file, "a") as log:
                                                    log.write(f"PDF {modified_pdf} Failed\n")
