...
from .csv_arxiv_paragraph_figures import CSVArxivParagraphFigure
from .csv_arxiv_paragraph_tables import CSVArxivParagraphTable
...
__all__ = [
    ...
    'CSVArxivParagraphFigure',
    'CSVArxivParagraphTable'
]
