...
class CSVOpenReviewRevisionsReviews:
    def __init__(self, csv_dir: str) -> None:
        self.csv_path = os.path.join(csv_dir, 'openreview_revisions_reviews.csv')
    ...
    def delete_revision_review_by_id(self, revision_openreview_id: str, review_openreview_id: str) -> Optional[pd.DataFrame]:
        ...
        if deleted_rows.empty:
            print(f"No connection found between revision {revision_openreview_id} and review {review_openreview_id}.")
            return None
    ...
    def delete_revision_review_by_review_id(self, review_openreview_id: str) -> Optional[pd.DataFrame]:
        ...
        if deleted_rows.empty:
            print(f"No connection found for review {review_openreview_id}.")
            return None
        ...
        print(f"The connection for review {review_openreview_id} is deleted successfully.")
        return deleted_rows
