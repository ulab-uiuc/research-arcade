"""
It seems that sometimes the knowledge debugger fails to extract citation information and figures.
In that case, the column corresponding to "citations" in the arxiv_id.json file and the arxiv_id directory under output/figures directory are empty.
Not quite sure if the problem comes from knowledge debugger or from my code.
"""
...
def main():
    ...
    for arxiv_id in ids:
        try:
            # Build the json file of paper using knowledge debugger
