...
# papers table
'''
node = sql_database.get_node_features("papers", {"paper_openreview_id": "00SnKBGTsz"})
print(node)
'''

# reviews table
'''
node = sql_database.get_node_features("reviews", {"review_openreview_id": "Is5Qh2Gs5x"})
print(node)
'''

# authors table
'''
node = sql_database.get_node_features("authors", {"author_openreview_id": "~A-Long_Jin1"})
print(node)
'''

# revisions table
'''
node = sql_database.get_node_features("revisions", {"modified_openreview_id": "AhzvtTGKFO"})
print(node)
'''
...
# papers table
'''
original_node_features = sql_database.delete_node("papers", {"paper_openreview_id": "zGej22CBnS"})
node = sql_database.get_node_features("papers", {"paper_openreview_id": "zGej22CBnS"})
print(node)
...
# reviews table
'''
original_node_features = sql_database.delete_node("reviews", {"review_openreview_id": "DHwZxFryth"})
node = sql_database.get_node_features("reviews", {"review_openreview_id": "DHwZxFryth"})
print(node)
...
# revisions table
'''
original_node_features = sql_database.delete_node("revisions", {"modified_openreview_id": "yfHQOp5zWc"})
node = sql_database.get_node_features("revisions", {"modified_openreview_id": "yfHQOp5zWc"})
print(node)
...
# authors table
'''
original_node_features = sql_database.delete_node("authors", {"author_openreview_id": "~ishmam_zabir1"})
node = sql_database.get_node_features("authors", {"author_openreview_id": "~ishmam_zabir1"})
print(node)
