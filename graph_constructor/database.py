...
class Database:
    ...
    def insert_paragraph(self, paragraph_id, content, paper_arxiv_id, paper_section):
        """
        Insert a section. Returns the generated section id
        - paragraph_id: str, the paragraph_id generated by the knowledge debugger stored in the "id" field of text node of jsonl
        - content: str, the extracted paragraph content.
        - paper_arxiv_id: str
        - paper_section: str
        """
